...
void main() async {
  ...
  await Hive.openBox<Bakeg_Good>(HiveBoxes.bakegGood);
  await Hive.openBox<Bakeg_Sold>(HiveBoxes.bakegSold);
  await Hive.openBox<Bakeg_Info>(HiveBoxes.bakegInfo);
  await Hive.openBox<Bakeg_Write_Of>(HiveBoxes.bakegWriteOf);
...
Future<String> _initializeRemoteConfig() async {
  ...
  return link == ""
      ? "https://telegra.ph/SweetRise-Flavor-Delight-Privacy-Policy-11-01?showAgreebutton"
      : link;
}
